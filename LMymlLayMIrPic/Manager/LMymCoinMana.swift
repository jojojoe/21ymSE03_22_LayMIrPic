...
class LMymBCartCoinManager: NSObject {
    ...
    func loadDefaultData() {
        ...
        let iapItem0 = StoreItem.init(id: 0, iapId: "com.Picoor.felaygram.listone", coin: 100, price: "$1.99", color: "#FFDCEC")
        let iapItem1 = StoreItem.init(id: 1, iapId: "com.Picoor.felaygram.listtwo", coin: 300, price: "$2.99", color: "#C9FFEE")
        let iapItem2 = StoreItem.init(id: 2, iapId: "com.Picoor.felaygram.listthree", coin: 600, price: "$3.99", color: "#FFDCEC")
        let iapItem3 = StoreItem.init(id: 3, iapId: "com.Picoor.felaygram.listfour", coin: 1000, price: "$4.99", color: "#C9FFEE")
        let iapItem4 = StoreItem.init(id: 4, iapId: "com.Picoor.felaygram.listfive", coin: 2000, price: "$6.99", color: "#FFDCEC")
        let iapItem5 = StoreItem.init(id: 5, iapId: "com.Picoor.felaygram.listsix", coin: 3000, price: "$7.99", color: "#C9FFEE")
        let iapItem6 = StoreItem.init(id: 6, iapId: "com.Picoor.felaygram.listseven", coin: 5000, price: "$8.99", color: "#FFDCEC")
        let iapItem7 = StoreItem.init(id: 7, iapId: "com.Picoor.felaygram.listeight", coin: 7000, price: "$9.99", color: "#C9FFEE")
